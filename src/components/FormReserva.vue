              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="origen" v-slot="{ field, errorMessage }">
                    <v-select label="Origen" :items="origenes" v-model="form.origen" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(2).svg" alt="" style="width: 16px; height: 16px" />
                      </template>
                    </v-select>
                  </Field>
                </v-col>
                <v-col cols="12" sm="6">
                  <Field name="destino" v-slot="{ field, errorMessage }">
                    <v-select label="Destino" :items="destinos" v-model="form.destino" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(2).svg" alt="" style="width: 16px; height: 16px" />
                      </template>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="tipoEnvio" v-slot="{ field, errorMessage }">
                    <v-select label="Tipo de envío" :items="shippingTypes" v-model="form.tipoEnvio" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Primary(1).svg" alt="" style="width: 22px; height: 22px" />
                      </template>
                    </v-select>
                  </Field>
                </v-col>
                <v-col cols="12" sm="6">
                  <Field name="tipoCarga" v-slot="{ field, errorMessage }">
                    <v-select label="Tipo de carga" :items="cargoTypes" v-model="form.tipoCarga" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/truck-ramp-box(1).svg" alt="" style="width: 22px; height: 22px" />
                      </template>
                    </v-select>
                  </Field>
                </v-col>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="peso" v-slot="{ field, errorMessage }">
                    <v-text-field label="Peso de la carga" type="number" variant="solo-filled" v-model="form.peso"
                      v-bind="field" :error-messages="errorMessage">
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/scale-unbalanced-flip.svg" alt=""
                ...
                <v-col cols="12" sm="6">
                  <Field name="volumenCarga" v-slot="{ field, errorMessage }">
                    <v-text-field label="Volumen de la Carga" type="number" variant="solo-filled"
                      v-model="form.volumenCarga" v-bind="field" :error-messages="errorMessage">
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/layer-group(1).svg" alt="" style="width: 22px; height: 22px" />
                      </template>
                    </v-text-field>
                  </Field>
                </v-col>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="country" v-slot="{ field, errorMessage }">
                    <v-select label="País" :items="paises" v-model="form.country" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(4).svg" alt="" style="width: 22px; height: 22px" />
                      </template>
                    </v-select>
                  </Field>
                </v-col>
                <v-col cols="12" sm="6">
                  <Field name="address" v-slot="{ field, errorMessage }">
                    <v-text-field label="Dirección" v-model="form.address" v-bind="field" :error-messages="errorMessage"
                      required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(2).svg" alt="" style="width: 16px; height: 16px" />
                      </template>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="emailCarga" v-slot="{ field, errorMessage }">
                    <v-text-field label="Tu email" v-model="form.emailCarga" v-bind="field" :error-messages="errorMessage"
                      required>
                ...
                <v-col cols="12" sm="6">
                  <Field name="phone" v-slot="{ field, errorMessage }">
                    <v-text-field label="Teléfono" v-model="form.phone" v-bind="field" :error-messages="errorMessage"
                      required>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="nombreRemitente" v-slot="{ field, errorMessage }">
                    <v-text-field label="Tu nombre" v-model="form.nombreRemitente" v-bind="field"
                      :error-messages="errorMessage" required>
                ...
                <v-col cols="12" sm="6">
                  <Field name="dniRemitente" v-slot="{ field, errorMessage }">
                    <v-text-field label="DNI" v-model="form.dniRemitente" v-bind="field" :error-messages="errorMessage"
                      required>
                      <template v-slot:prepend-inner>
                        <v-icon icon="mdi-card-account-details-outline" /> </template></v-text-field>
                  </Field>
                </v-col>
              </v-row>
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="paisRemitente" v-slot="{ field, errorMessage }">
                    <v-select label="País" :items="paises" v-model="form.paisRemitente" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(4).svg" alt="" style="width: 22px; height: 22px" />
                      </template>
                ...
                <v-col cols="12" sm="6">
                  <Field name="direccionRemitente" v-slot="{ field, errorMessage }">
                    <v-text-field label="Dirección" v-model="form.direccionRemitente" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(2).svg" alt="" style="width: 16px; height: 16px" />
                      </template>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="emailRemitente" v-slot="{ field, errorMessage }">
                    <v-text-field label="Tu email" v-model="form.emailRemitente" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner> <v-icon icon="mdi-email-outline" /> </template>
                    </v-text-field>
                  </Field>
                ...
                <v-col cols="12" sm="6">
                  <Field name="telefonoRemitente" v-slot="{ field, errorMessage }">
                    <v-text-field label="Teléfono" v-model="form.telefonoRemitente" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner> <v-icon icon="mdi-phone-outline" /> </template>
                    </v-text-field>
                  </Field>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="nombreDestinatario" v-slot="{ field, errorMessage }">
                    <v-text-field label="Tu nombre" v-model="form.nombreDestinatario" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner> <v-icon icon="mdi-account-outline" /> </template>
                    </v-text-field>
                  </Field>
                ...
                <v-col cols="12" sm="6">
                  <Field name="dniDestinatario" v-slot="{ field, errorMessage }">
                    <v-text-field label="DNI" v-model="form.dniDestinatario" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <v-icon icon="mdi-card-account-details-outline" /> </template></v-text-field>
                  </Field>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="paisDestinatario" v-slot="{ field, errorMessage }">
                    <v-select label="País" :items="paises" v-model="form.paisDestinatario" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(4).svg" alt="" style="width: 22px; height: 22px" />
                      </template>
                ...
                <v-col cols="12" sm="6">
                  <Field name="direccionDestinatario" v-slot="{ field, errorMessage }">
                    <v-text-field label="Dirección" v-model="form.direccionDestinatario" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner>
                        <img src="/public/formReserva/Vector(2).svg" alt="" style="width: 16px; height: 16px" />
                      </template>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="emailDestinatario" v-slot="{ field, errorMessage }">
                    <v-text-field label="Tu email" v-model="form.emailDestinatario" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner> <v-icon icon="mdi-email-outline" /> </template>
                    </v-text-field>
                  </Field>
                ...
                <v-col cols="12" sm="6">
                  <Field name="telefonoDestinatario" v-slot="{ field, errorMessage }">
                    <v-text-field label="Teléfono" v-model="form.telefonoDestinatario" v-bind="field"
                      :error-messages="errorMessage" required>
                      <template v-slot:prepend-inner> <v-icon icon="mdi-phone-outline" /> </template>
                    </v-text-field>
                  </Field>
              ...
              <v-row>
                <v-col cols="12" sm="6">
                  <Field name="emailDocumentos" v-slot="{ field, errorMessage }">
                    <v-text-field label="Tu email" v-model="form.emailDocumentos" v-bind="field"
                      :error-messages="errorMessage" required />
                  </Field>
                </v-col>
                <v-col cols="12" sm="6">
                  <Field name="telefonoDocumentos" v-slot="{ field, errorMessage }">
                    <v-text-field label="Teléfono" v-model="form.telefonoDocumentos" v-bind="field"
                      :error-messages="errorMessage" required />
                  </Field>
                </v-col>
              </v-row>
...
const schema = yup.object({
  ...
  volumenCarga: yup.number().required('El volumen debe ser positivo y es requerido').nullable().positive(),
  ...
  emailRemitente: yup.string().email('Ingrese un email válido').required('El email del remitente es requerido'),
  ...
  emailDestinatario: yup.string().email('Ingrese un email válido').required('El email del destinatario es requerido'),
